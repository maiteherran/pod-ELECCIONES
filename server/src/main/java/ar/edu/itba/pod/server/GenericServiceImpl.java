...
public class GenericServiceImpl {
    ...
    public void addVote(int pollingStationId, ProvinceName province, List<Party> vote) throws IllegalVoteException {
    ...
    private TreeSet<MutablePair<Party, Double>> getNationalResultsRec (TreeSet<MutablePair<Party, Double>> results, int choice, boolean finalResults) {
        ...
        for (Province p: provinces) {
            ...
            TreeSet<MutablePair<Party, Double>> resultsProv = p.getResultsAV(choice, results.pollLast().getLeft());
    ...
    private Province getProvince (ProvinceName name) throws NoSuchProvinceException {
